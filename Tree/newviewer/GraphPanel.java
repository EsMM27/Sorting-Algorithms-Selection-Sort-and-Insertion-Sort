...
import newviewer.GraphPanel.BinarySearchTreeViewCapable.NodeConstants;
//import com.newviewer.GraphPanel.Kind;
import newviewer.RedBlackTree.Node;
...
/*************************************************************************************************************************/
	...
	public class BinarySearchTreeViewCapable<T extends Comparable<T>> extends RedBlackTree<T> 
    {
    	...
    	public void insert(T value){
    		...
    		if ( myRoot == null ) {
    			myRoot = node;
    			super.root = myRoot;  // Keep both roots in sync
    			//Now that we've inserted we need to make it Red-Black (if necessary)
    			super.handleRedBlack(node);
    		}
    		else
    		{
    			// Set super.root to myRoot before insertion so rotations work correctly
    			super.root = myRoot;
    			...
    			// After handleRedBlack (which may do rotations), super.root might have changed
    			// Update myRoot to point to the new root
